      ...
      <li className="p-1">
        <div className="relative flex items-center w-[20em]">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-[0.6em] rounded-[0.6em]  border-1 bg-transparent text-blackText dark:text-whiteText placeholder-grayText outline-none focus:ring-2 focus:ring-orange transition-all duration-200 focus:!text-white"
          />
        </div>
      </li>
