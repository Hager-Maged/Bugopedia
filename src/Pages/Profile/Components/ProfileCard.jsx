      ...
      <CardBody className="pt-0">
        <div className="flex flex-col items-center gap-4 p-4 md:flex-row md:items-start md:gap-6 md:p-5">
          ...
          <div className="flex flex-col items-center flex-1 md:items-start ">
            ...
            <Typography className="mt-1 text-lg text-center text-blue-gray-800 md:text-left dark:text-lightPink">
              {title}
            </Typography>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mt-6 text-sm text-blue-gray-800 md:gap-6 md:justify-start dark:text-lightPink">
